...
interface EmergencyCleaningModalProps {
  visible: boolean;
  onClose: () => void;
  navigation?: any;
}

export function EmergencyCleaningModal({ visible, onClose, navigation }: EmergencyCleaningModalProps) {
          ...
          [
            {
              ...
              onPress: () => {
                onClose();
                // Navigate to the job details if navigation is available
                if (navigation) {
