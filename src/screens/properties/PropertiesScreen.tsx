...
export default function PropertiesScreen() {
  ...
  const handleSaveProperty = async () => {
    ...
    try {
      ...
      // If we still don't have coordinates, show an error instead of using fake ones
      ...
      if (user?.uid) {
        ...
        if (showEditProperty && editingProperty) {
          ...
          if (removingIcalUrl || changingIcalUrl) {
            ...
            try {
              // Remove all iCal jobs before updating
          ...
          await updateProperty(
            ...
            editingProperty.id,
            {
              ...
              coords: coordinates,
              label: finalLabel,
              icalUrl: finalIcalUrl || null  // Ensure null when empty
            }
          );
